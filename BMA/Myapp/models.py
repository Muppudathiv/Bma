...
class StockGroup(models.Model):
    StockGroup_Id = models.CharField(primary_key=True, max_length=24, default=generate_add_gst_id, editable=False)
...
class StockCategory(models.Model):
    Category_Id = models.CharField(primary_key=True, max_length=24, default=generate_add_gst_id, editable=False)
...
class StockGroupTaxDetails(models.Model):
    TaxDetails_id = models.CharField(primary_key=True, max_length=24, default=generate_add_gst_id, editable=False)
...
class ProductDescription(models.Model):
    Description_id = models.CharField(primary_key=True, max_length=24, default=generate_add_gst_id, editable=False)
